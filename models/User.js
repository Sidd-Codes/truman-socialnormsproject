...
const userSchema = new mongoose.Schema({
    ...
    posts: [new Schema({
        ...
        comments: [new Schema({
            ...
            harmful: { type: Boolean, default: false }, // Indicates if the user has marked the comment as harmful
    ...
    feedAction: [new Schema({
        ...
        liked: { type: Boolean, default: false }, // Indicates if the user has liked the post
        harmful: { type: Boolean, default: false }, // Indicates if the user has marked the post as harmful
        ...
        harmfulTime: [Date], // List of absolute times when the user has marked the post as harmful
